...
export const metadata: Metadata = {
  ...
  description:
    "Get your fire alarm, sprinkler, security, or low-voltage project done now and pay monthly. Through Acorn Finance, compare offers from 12+ lenders — up to $100,000, rates as low as 6% APR, funding in 1–2 business days. Checking your rate won't affect your credit.",
  keywords: [
