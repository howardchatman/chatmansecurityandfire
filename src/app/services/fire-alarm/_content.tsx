    ...
    <>
      ...
      <main className="pt-20">
        <section
          ...
          style={{ backgroundImage: "url('/fire_alarm_wide.png')", backgroundSize: "cover", backgroundPosition: "center", backgroundColor: "#1a1a1a" }}
        >
          ...
          <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Commercial Fire Alarm Systems — Service, Repairs & Corrections in Houston, TX
              </h1>
          ...
          <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <h2 className="text-2xl font-bold text-gray-900 mb-6">Services Include</h2>
                ...
                <div className="bg-gray-50 rounded-2xl p-8 mb-8">
                  ...
                  <p className="text-3xl font-bold text-orange-600">$750 – $5,000+</p>
                </div>
                <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 mb-12">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">We do not offer DIY monitoring packages. All work is commercial-grade and inspection-focused.</p>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-900 rounded-2xl p-8 text-center">
                  <h3 className="text-2xl font-bold text-white mb-4">Need fire alarm service in Houston?</h3>
                  <a href="tel:+18328597009" className="inline-flex items-center gap-2 px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-full transition-colors">
                    <Phone className="w-5 h-5" />
                    Call (832) 859-7009
                  </a>
      ...
      <ServiceLeadForm service="Fire Alarm Systems" heading="Request a Free Fire Alarm Estimate" />
      <Footer />
      <ChadChat />
    </>
  );
