...
export default function EmergencyLightingContent() {
  return (
    <>
      <Navbar />
          ...
          <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
              ...
              <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
                Emergency Lighting & Exit Sign Repairs in Houston, TX
              </h1>
          ...
          <div className="container-custom mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <h2 className="text-2xl font-bold text-gray-900 mb-6">We Correct</h2>
                ...
                <div className="bg-gray-50 rounded-2xl p-8 mb-12">
                  ...
                  <p className="text-3xl font-bold text-orange-600">$750 – $2,500</p>
                </div>
      ...
      <ServiceLeadForm service="Emergency Lighting" heading="Get Emergency Lighting Fixed Fast" />
      <Footer />
      <ChadChat />
    </>
  );
