...
export default function ProposalViewer({ params }: { params: Promise<{ id: string }> }) {
  ...
  async function sendMessage() {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: "assistant", content: "Connection issue. Please call Howard at (346) 852-5540." }]);
    }
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#F9FAFB" }}>
        <div style={{ textAlign: "center", maxWidth: 400, padding: 24 }}>
          ...
          <a href="tel:+13468525540" style={{ display: "inline-block", background: O, color: "#fff", padding: "12px 24px", borderRadius: 8, fontWeight: 600, textDecoration: "none" }}>
            Call (346) 852-5540
          </a>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "20px 16px" }}>
        ...
        <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #E5E7EB", padding: 20, marginBottom: 16 }}>
          ...
          {callStatus === "error" && (
            <div style={{
              ...
              <a href="tel:+13468525540" style={{ fontSize: 13, color: O, fontWeight: 600, textDecoration: "none" }}>Call (346) 852-5540</a>
            </div>
          )}
        ...
        <div style={{ textAlign: "center", padding: "20px 0 40px", color: "#9CA3AF", fontSize: 11 }}>
          ...
          <p style={{ marginTop: 4 }}>
            ...
            {" | "}
            <a href="tel:+13468525540" style={{ color: O, textDecoration: "none" }}>(346) 852-5540</a>
          </p>
        </div>
      </div>
    </div>
